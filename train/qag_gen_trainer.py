...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model_name", type=str, default="yes sir")
...
def prep_model(model_name: str, device: str, tokenizer: T5Tokenizer) -> T5ForConditionalGeneration:
...
if __name__ == "__main__":
    ...
    test_set = QAGDataset(dataset["test"], args.max_length)
